...
if(global.status_heroi==true){
var _heroi = heroi.heroi_get();
var pos_x = ui_padding_x + (ui_border_size * 10);
for(var heroi_index = 0; heroi_index < array_length(_heroi); heroi_index++) {
	...
	draw_text(pos_x, pos_y, $"Nome do Heroi: {mostrar_descricao.nome} ");
